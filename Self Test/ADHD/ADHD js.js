...
var set1=["Do you find it difficult to finish a task or project? ","Do you find it difficult to organize myself or a task? ","Do you start delaying a task if it requires a lot of thought? "," Do you find that most of your tasks (work/school assignments, etc.) are boring or repetitive, making them difficult to complete? ","Do you find yourself making careless mistakes when engaged in something you feel is boring repetitive, or difficult?  ","Do you regularly fail to remember important appointments or obligations? ","Do you have difficulty concentrating on people when they are speaking to you? ","Do you frequently misplace things or have difficulty finding them? ","Are you typically distracted or find it hard to focus when there is activity or noise around you? ","Do you find yourself avoiding situations like waiting your turn in line when waiting is expected and appropriate (i.e. at the grocery store)? " ];

var set2=["Do you find it difficult to finish a task or project? ","Do you find it difficult to organize myself or a task? ","Do you start delaying a task if it requires a lot of thought? "," Do you find that most of your tasks (work/school assignments, etc.) are boring or repetitive, making them difficult to complete? ","Do you find yourself making careless mistakes when engaged in something you feel is boring repetitive, or difficult?  ","Do you regularly fail to remember important appointments or obligations? ","Do you have difficulty concentrating on people when they are speaking to you? ","Do you frequently misplace things or have difficulty finding them? ","Are you typically distracted or find it hard to focus) when there is activity or noise around you? ","Do you find yourself avoiding situations like waiting your turn in line when waiting is expected and appropriate (i.e. at the grocery store)? " ];

var set3=["Do you find it difficult to finish a task or project? ","Do you find it difficult to organize myself or a task? ","Do you start delaying a task if it requires a lot of thought? "," Do you find that most of your tasks (work/school assignments, etc.) are boring or repetitive, making them difficult to complete? ","Do you find yourself making careless mistakes when engaged in something you feel is boring repetitive, or difficult?  ","Do you regularly fail to remember important appointments or obligations? ","Do you have difficulty concentrating on people when they are speaking to you? ","Do you frequently misplace things or have difficulty finding them? ","Are you typically distracted or find it hard to focus) when there is activity or noise around you? ","Do you find yourself avoiding situations like waiting your turn in line when waiting is expected and appropriate (i.e. at the grocery store)? " ];

var set4=["Do you find it difficult to finish a task or project? ","Do you find it difficult to organize myself or a task? ","Do you start delaying a task if it requires a lot of thought? "," Do you find that most of your tasks (work/school assignments, etc.) are boring or repetitive, making them difficult to complete? ","Do you find yourself making careless mistakes when engaged in something you feel is boring repetitive, or difficult?  ","Do you regularly fail to remember important appointments or obligations? ","Do you have difficulty concentrating on people when they are speaking to you? ","Do you frequently misplace things or have difficulty finding them? ","Are you typically distracted or find it hard to focus) when there is activity or noise around you? ","Do you find yourself avoiding situations like waiting your turn in line when waiting is expected and appropriate (i.e. at the grocery store)? " ];

var set5=["Do you find it difficult to finish a task or project? ","Do you find it difficult to organize myself or a task? ","Do you start delaying a task if it requires a lot of thought? "," Do you find that most of your tasks (work/school assignments, etc.) are boring or repetitive, making them difficult to complete? ","Do you find yourself making careless mistakes when engaged in something you feel is boring repetitive, or difficult?  ","Do you regularly fail to remember important appointments or obligations? ","Do you have difficulty concentrating on people when they are speaking to you? ","Do you frequently misplace things or have difficulty finding them? ","Are you typically distracted or find it hard to focus) when there is activity or noise around you? ","Do you find yourself avoiding situations like waiting your turn in line when waiting is expected and appropriate (i.e. at the grocery store)? " ];

var set6=["Do you find it difficult to finish a task or project? ","Do you find it difficult to organize myself or a task? ","Do you start delaying a task if it requires a lot of thought? "," Do you find that most of your tasks (work/school assignments, etc.) are boring or repetitive, making them difficult to complete? ","Do you find yourself making careless mistakes when engaged in something you feel is boring repetitive, or difficult?  ","Do you regularly fail to remember important appointments or obligations? ","Do you have difficulty concentrating on people when they are speaking to you? ","Do you frequently misplace things or have difficulty finding them? ","Are you typically distracted or find it hard to focus) when there is activity or noise around you? ","Do you find yourself avoiding situations like waiting your turn in line when waiting is expected and appropriate (i.e. at the grocery store)? " ];
...
function results(){
	...
	if(score>=40){
		...
		endMsg("You're fully engaged in self-reflection and adjustment. Your high level of alertness indicates a dynamic approach to managing ADHD. Continue to fine-tune your strategies, and remember, it's a continuous process of growth and improvement");
	}
	else if(score>=27 && score<40){
		templates = '<div class="alertHead" id="highAlert">You are at a High Risk !</div>';
		document.getElementById('box2').innerHTML += templates;
		endMsg("You're in a proactive phase now. Establishing routines and utilizing tools show that you're committed to creating a structured environment. This increased alertness is empowering your journey to better manage daily challenges!");
		
	}
	else if(score>=16 && score<27){
		templates = '<div class="alertHead" id="mediumAlert">You are at a Medium Risk !</div>';
		document.getElementById('box2').innerHTML += templates;
		endMsg("You're becoming more aware of the nuances of ADHD. As you educate yourself and consider building a support system, you're actively taking charge of your well-being. Keep going; you're making progress!");
		
	}
	else if(score>=6 && score<16){
		templates = '<div class="alertHead" id="lessAlert">You are at Less Risk !</div>';
		document.getElementById('box2').innerHTML += templates;
		endMsg("Recognize that you have the power to improve. Take a moment to absorb information about ADHD, and don't be too hard on yourself. You're on the path to learning and growth!");
		
	}
	else if(score>=0 && score<6){
		templates = '<div class="alertHead" id="veryLessAlert">You are at a very Low Risk ! </div>';
		document.getElementById('box2').innerHTML += templates;
		endMsg("It's okay to take things one step at a time. You're doing well, and acknowledging your challenges is the first step towards understanding and managing them!");
